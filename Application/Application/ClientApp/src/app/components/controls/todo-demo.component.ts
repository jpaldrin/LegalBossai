    ...
    fetch(cb) {
        ...
        if (data == null) {
            setTimeout(() => {
                ...
                if (data == null) {
                    data = [
                        { "completed": true, "important": true, "name": "Cosmo, take a look at creating visual studio VSIX", "description": "Create a visual studio VSIX extension package that will add this project as an aspnet-core project template" },
                        { "completed": false, "important": true, "name": "Cosmo, Do a quick how-to writeup", "description": "" },
                        {
                            "completed": false, "important": false, "name": "Ng-6 Tuts for Core 2.1", "description": "Cosmo, you can create tutorial videa on how to's then link the video back to your landing page. Great way to attract b2b clients and increase revenue. I think I want to share the legal a.i. as open source. Giving this to the world opens the door even wider and we can make a positive change to fighting the injustice of justice, :)" +
                            " When you look at this tutorial just create a similar video for yourself and then set that to your company, building legal boss a.i with JnT Software! My partner and I want to come see you..."
                        },
                    ];
                }
