...
import { EvictionsComponent } from "./components/evictions/evictions.component";
...
const routes: Routes = [
  ...
  { path: "evictions", component: EvictionsComponent, canActivate: [AuthGuard], data: { title: "Evictions" } },
