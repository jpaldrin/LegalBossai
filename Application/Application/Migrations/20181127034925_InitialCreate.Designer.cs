...
namespace Application.Migrations
{
    ...
    [Migration("20181127034925_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.DocumentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Eviction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<Guid?>("LegalAgentAgentId");
                    ...
                    b.HasIndex("LegalAgentAgentId");

                    b.ToTable("AppEvictions");
                });

            modelBuilder.Entity("DAL.Models.EvictionDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("EvictionId");

                    b.ToTable("AppEvictionDetails");
                });
            ...
            modelBuilder.Entity("DAL.Models.Document", b =>
                {
                    b.HasOne("DAL.Models.DocumentCategory", "DocumentCategory")
                        .WithMany("Documents")
                        .HasForeignKey("DocumentCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DAL.Models.Document", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("DAL.Models.Eviction", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Agent", "LegalAgent")
                        .WithMany()
                        .HasForeignKey("LegalAgentAgentId");
                });

            modelBuilder.Entity("DAL.Models.EvictionDetail", b =>
                {
                    b.HasOne("DAL.Models.Document", "Document")
                        .WithMany("EvictionDetails")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DAL.Models.Eviction", "Evctions")
                        .WithMany("EvictionDetails")
                        .HasForeignKey("EvictionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
